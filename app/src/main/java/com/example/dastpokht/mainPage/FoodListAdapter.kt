...
class FoodListAdapter(private val onItemClick: (Hit) -> Unit) :
    ListAdapter<Hit, FoodListAdapter.FoodListViewHolder>(HitDiffCalBack()) {


    inner class FoodListViewHolder(binding: RecyclerViewFoodListBinding) :
